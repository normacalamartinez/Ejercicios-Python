...
#coding:utf-8
#################### #################### #################### #################### #################### #################### 
             ############################### PROGRAMA DE ATENCION AL CLIENTE UNIVERSIDAD  ############################
#################### #################### #################### #################### #################### #################### 
...
import Librerias_Atencion_al_Cliente  as lib_ac


encabezado = lib_ac.getencabezado()

print("""            Hola!, es un gusto saludarte, Bienvenido a Nuestro canal.
...
while continuar:
    ...
    if escribir_mensaje == "S" or escribir_mensaje == "s" or escribir_mensaje == "":
        ...
        continuar = False
    # En caso que sea otra respuesta, vamos a decidir salir.Asi, en la siguiente iteracion el ciclo terminara.
    else:
        lib_ac.getalerta()
